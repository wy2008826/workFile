...
define(function(require, exports, module) {
	...
	$(function(){
		...
		//如何使用
		$("#goHowToUse").on("click",function(){
			location.href = weburl+ "/app/how-to-use.html";
		})
		...
		require.async('dropload', function() {
			$('#pageWrap').dropload({
		        ...
		        loadUpFn : function(me){
		            ...
		            $.ajax({
				        type:"get",
				        url:wapurl+"/api/member/cashCoupon.html?page=1&pageSize=5&flag=1&randomTime="+(new Date()).getTime(),
				        dataType:"jsonp",
				        jsonp:"callback",
		        ...
		        loadDownFn : function(me){
		        	$.ajax({
				        type:"get",
				        url:wapurl+"/api/member/cashCoupon.html?page="+page+"&pageSize=5&flag=1&randomTime="+(new Date()).getTime(),
				        dataType:"jsonp",
				        jsonp:"callback",
						jsonpCallback:"jsonpCallback",
				        success:function(data){
